...
void BreakpointPropertyDlg::OnBrowseClick( wxCommandEvent& event )
{
   ...
   wxASSERT( docMan );
   wxDocTemplate* doctemp = docMan->FindTemplateForPath( "dummy.bb" );
   wxASSERT( doctemp );
   wxString fileFilter;
   ...
   wxFileDialog dlg( this, "Select A Blitz File", file.GetPath(), file.GetFullName(), fileFilter, wxOPEN | wxFILE_MUST_EXIST );
