...
////@end SettingsDlg content construction
   ...
   id = m_PropGrid->Append( TSColourProperty(wxT("Label Color"), wxPG_LABEL, tsGetPrefs().GetLabelColor()) );
   m_PropGrid->SetPropertyHelpString( id, wxT("The color used for labels in the script editor window.") );
...
void SettingsDlg::OnOkClick( wxCommandEvent& event )
{
   ...
   tsGetPrefs().SetLabelColor( *wxGetVariantCast( m_PropGrid->GetPropertyValue( "Editor.Label Color" ), wxColour ) );
