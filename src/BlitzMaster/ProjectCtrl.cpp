...
void ProjectCtrl::NewFolder( wxTreeItemId item )
{
   ...
   {
      wxMessageDialog dlg( this, "The folder could not be created!", APP_NAME, wxOK | wxICON_ERROR );
      dlg.ShowModal();
      return;
   }
...
void ProjectCtrl::NewFile( wxTreeItemId item )
{
   ...
   if ( !dummy.IsOpened() )
   {
      wxMessageDialog dlg( this, "The file could not be created!", APP_NAME, wxOK | wxICON_ERROR );
      dlg.ShowModal();
      return;
   }
